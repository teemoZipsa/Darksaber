...
const RAW_ITEMS: RawItemDef[] = [
    ...
    {
        id: 'orig_story_0015_short_bow', name: 'Short Bow', nameKr: '쇼트보우',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🏹',
        iconSprite: { col: 15, row: 0 },
        maxDurability: 300,
        stats: { atk: 35 },
        attackRange: 5,
        description: 'Original Darksaber bow reward. Preserves GETITEM 015 and original price 12000.',
        descriptionKr: '원작 다크세이버 활 보상. GETITEM 015와 원작 가격 12000을 보존합니다. 길이가 짧지만 범위가 넓은 활.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 12000,
        requiredLevel: 0,
    ...
    {
        id: 'orig_story_0110_ice_shield', name: 'Ice Shield', nameKr: '아이스 실드',
        slot: 'shield', gridW: 2, gridH: 2, color: '#8fa8b8', icon: '🛡️',
        iconSprite: { col: 37, row: 0 },
        maxDurability: 300,
        stats: { def: 20 },
        magicRange: 2,
        description: 'Original Darksaber shield reward. Preserves GETITEM 110 and original price 50000.',
        descriptionKr: '원작 다크세이버 방패 보상. GETITEM 110과 원작 가격 50000을 보존합니다. 신의 눈물이 결정체가 되어 만들어진 방패(물속성 대미지 반감).',
        rarity: 'unique',
        weight: 2.6,
        baseValue: 50000,
        requiredLevel: 0,
    ...
    {
        id: 'orig_story_0854_crystal_mail6', name: 'Crystal Mail 6', nameKr: '크리스탈 메일6',
        slot: 'body', gridW: 2, gridH: 3, color: '#7f8c8d', icon: '🦺',
        iconSprite: { col: 63, row: 2 },
        maxDurability: 900,
        stats: { def: 30, evasion: 10 },
        description: 'Original Darksaber body armor reward. Preserves GETITEM 854 and original price 100000.',
        descriptionKr: '원작 다크세이버 갑옷 보상. GETITEM 854와 원작 가격 100000을 보존합니다. 투명한 재료로 만들어진 갑옷, 강한 방어력을 가진다.',
        rarity: 'unique',
        weight: 5.4,
        baseValue: 100000,
        requiredLevel: 76,
    ...
    {
        id: 'orig_story_0578_zambia7', name: 'Zambia 7', nameKr: '잠비아7',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🗡️',
        iconSprite: { col: 71, row: 1 },
        maxDurability: 4000,
        stats: { atk: 155 },
        attackRange: 1,
        description: 'Original Darksaber weapon reward. Preserves GETITEM 578 and original price 500000.',
        descriptionKr: '원작 다크세이버 무기 보상. GETITEM 578과 원작 가격 500000을 보존합니다. 칼날의 끝이 휘어 있는 단검, 칼날이 매우 두껍다.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 500000,
        requiredLevel: 106,
    ...
    {
        id: 'orig_story_0148_crown', name: 'Crown', nameKr: '크라운',
        slot: 'head', gridW: 2, gridH: 2, color: '#7f8c8d', icon: '⛑️',
        iconSprite: { col: 45, row: 0 },
        maxDurability: 300,
        stats: { def: 3, magDef: 3 },
        magicRange: 3,
        description: 'Original Darksaber helm reward. Preserves GETITEM 148 and original price 90000.',
        descriptionKr: '원작 다크세이버 투구 보상. GETITEM 148과 원작 가격 90000을 보존합니다. 왕의 증표를 나타내는 머리장식, 병사들의 사기가 증가됨.',
        rarity: 'unique',
        weight: 1.8,
        baseValue: 90000,
        requiredLevel: 0,
    ...
    {
        id: 'orig_story_0262_levitation_boots', name: 'Levitation Boots', nameKr: '레비테이션 부츠',
        slot: 'boots', gridW: 2, gridH: 2, color: '#7f8c8d', icon: '🥾',
        iconSprite: { col: 81, row: 0 },
        maxDurability: 300,
        stats: { def: 1 },
        magicRange: 1,
        description: 'Original Darksaber boots reward. Preserves GETITEM 262 and original price 60000.',
        descriptionKr: '원작 다크세이버 장화 보상. GETITEM 262와 원작 가격 60000을 보존합니다. 몸을 뜨게 하여 땅속성 마법을 무시한다(땅속성마법 무효화).',
        rarity: 'unique',
        weight: 1.8,
        baseValue: 60000,
        requiredLevel: 0,
    ...
    {
        id: 'orig_story_0632_flail_saber7', name: 'Flail Saber 7', nameKr: '플레일 세이버7',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🗡️',
        iconSprite: { col: 13, row: 0 },
        maxDurability: 4000,
        stats: { atk: 140, hitRate: 20 },
        attackRange: 1,
        description: 'Original Darksaber weapon reward. Preserves GETITEM 632 and original price 600000.',
        descriptionKr: '원작 다크세이버 무기 보상. GETITEM 632와 원작 가격 600000을 보존합니다. 특히 생명체에 강한 효과를 가지는 세이버의 다른 형태.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 600000,
        requiredLevel: 106,
    ...
    {
        id: 'orig_story_0855_crystal_mail7', name: 'Crystal Mail 7', nameKr: '크리스탈 메일7',
        slot: 'body', gridW: 2, gridH: 3, color: '#7f8c8d', icon: '🦺',
        iconSprite: { col: 63, row: 2 },
        maxDurability: 1000,
        stats: { def: 37, evasion: 10 },
        description: 'Original Darksaber body armor reward. Preserves GETITEM 855 and original price 150000.',
        descriptionKr: '원작 다크세이버 갑옷 보상. GETITEM 855와 원작 가격 150000을 보존합니다. 투명한 재료로 만들어진 갑옷, 강한 방어력을 가진다.',
        rarity: 'unique',
        weight: 5.4,
        baseValue: 150000,
        requiredLevel: 106,
    ...
    {
        id: 'orig_story_0010_jack_knife', name: 'Jack Knife', nameKr: '잭 나이프',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🗡️',
        iconSprite: { col: 10, row: 0 },
        maxDurability: 300,
        stats: { atk: 55 },
        attackRange: 1,
        description: 'Original Darksaber weapon reward. Preserves GETITEM 010 and original price 15000.',
        descriptionKr: '원작 다크세이버 무기 보상. GETITEM 010과 원작 가격 15000을 보존합니다. 칼날을 숨길 수 있는 칼로 단도보다 작고 칼이 얇다.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 15000,
        requiredLevel: 6,
    ...
    {
        id: 'orig_story_0018_power_staff', name: 'Power Staff', nameKr: '힘의 지팡이',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🪄',
        iconSprite: { col: 18, row: 0 },
        maxDurability: 300,
        stats: { atk: 30 },
        attackRange: 1,
        description: 'Original Darksaber staff reward. Preserves GETITEM 018, magic 2101, and original price 250000.',
        descriptionKr: '원작 다크세이버 지팡이 보상. GETITEM 018, 발동마법 2101, 원작 가격 250000을 보존합니다. 공격 마법을 강화한다(어택마법 LV1UP).',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 250000,
        requiredLevel: 0,
    ...
    {
        id: 'orig_story_0974_longinus', name: 'Longinus', nameKr: '롱기누스',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🔱',
        iconSprite: { col: 49, row: 3 },
        maxDurability: 6000,
        stats: { atk: 220 },
        attackRange: 2,
        description: 'Original Darksaber relic weapon. Preserves GETITEM 974 and original price 0.',
        descriptionKr: '원작 다크세이버 유물 무기. GETITEM 974와 원작 가격 0을 보존합니다. 극도의 필살률을 지닌 창.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_1037_earth_armageddon', name: 'Earth Armageddon', nameKr: '어스아마게돈',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🪄',
        iconSprite: { col: 12, row: 4 },
        maxDurability: 2000,
        stats: { atk: 200, magAtk: 40, magDef: 150 },
        attackRange: 1,
        description: 'Original Darksaber relic staff. Preserves GETITEM 1037, magic 906, and original price 0.',
        descriptionKr: '원작 다크세이버 유물 지팡이. GETITEM 1037, 발동마법 906, 원작 가격 0을 보존합니다. 강력한 마공을 지니고 있으며 일정확률로 어스케이크 마법을 구사하는 지팡이.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_0995_valkyrie', name: 'Valkyrie', nameKr: '발키리',
        slot: 'body', gridW: 2, gridH: 3, color: '#7f8c8d', icon: '🦺',
        iconSprite: { col: 70, row: 3 },
        maxDurability: 2000,
        stats: { def: 60 },
        description: 'Original Darksaber relic armor. Preserves GETITEM 995 and original price 0.',
        descriptionKr: '원작 다크세이버 유물 갑옷. GETITEM 995와 원작 가격 0을 보존합니다. 여신 발키리의 힘이 깃든 재킷.',
        rarity: 'unique',
        weight: 5.4,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_0990_bernium', name: 'Bernium', nameKr: '베르니움',
        slot: 'body', gridW: 2, gridH: 3, color: '#7f8c8d', icon: '🦺',
        iconSprite: { col: 65, row: 3 },
        maxDurability: 1300,
        stats: { def: 65, magAtk: 15 },
        magicRange: 10,
        description: 'Original Darksaber relic armor. Preserves GETITEM 990 and original price 0.',
        descriptionKr: '원작 다크세이버 유물 갑옷. GETITEM 990과 원작 가격 0을 보존합니다. 마력의 힘을 지닌 아머.',
        rarity: 'unique',
        weight: 5.4,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_0970_enigma_blade', name: 'Enigma Blade', nameKr: '이니그마 블레이드',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🗡️',
        iconSprite: { col: 45, row: 3 },
        maxDurability: 3000,
        stats: { atk: 210 },
        attackRange: 1,
        description: 'Original Darksaber relic weapon. Preserves GETITEM 970, magic 10405, and original price 0.',
        descriptionKr: '원작 다크세이버 유물 무기. GETITEM 970, 발동마법 10405, 원작 가격 0을 보존합니다. 애토맥웨이브의 정령이 숨겨져 있는 검.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_1035_discovery', name: 'Discovery', nameKr: '디스커버리',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🪄',
        iconSprite: { col: 10, row: 4 },
        maxDurability: 5000,
        stats: { atk: 150, def: 30, magAtk: 40, magDef: 100, evasion: 5 },
        attackRange: 1,
        description: 'Original Darksaber relic staff. Preserves GETITEM 1035, magic 2506, and original price 0.',
        descriptionKr: '원작 다크세이버 유물 지팡이. GETITEM 1035, 발동마법 2506, 원작 가격 0을 보존합니다. 강력한 방어막을 생성하여 아군의 체력을 높여주는 지팡이.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_0969_excalibur', name: 'Excalibur', nameKr: '엑스칼리버',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🗡️',
        iconSprite: { col: 44, row: 3 },
        maxDurability: 3000,
        stats: { atk: 220 },
        attackRange: 1,
        description: 'Original Darksaber relic weapon. Preserves GETITEM 969 and original price 0.',
        descriptionKr: '원작 다크세이버 유물 무기. GETITEM 969와 원작 가격 0을 보존합니다. 전설의 아더왕의 영혼이 담긴 검.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_1015_gr_carium', name: 'GR. Carium', nameKr: 'GR.캐리엄',
        slot: 'boots', gridW: 2, gridH: 2, color: '#7f8c8d', icon: '🥾',
        iconSprite: { col: 90, row: 3 },
        maxDurability: 1200,
        stats: { def: 40 },
        description: 'Original Darksaber relic boots. Preserves GETITEM 1015, magic 11003, and original price 0.',
        descriptionKr: '원작 다크세이버 유물 장화. GETITEM 1015, 발동마법 11003, 원작 가격 0을 보존합니다. 성왕캐리엄의 영기가 서른 신발.',
        rarity: 'unique',
        weight: 1.8,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_1000_arondight', name: 'Arondight', nameKr: '아론다이트',
        slot: 'body', gridW: 2, gridH: 3, color: '#7f8c8d', icon: '🦺',
        iconSprite: { col: 75, row: 3 },
        maxDurability: 2000,
        stats: { def: 70, magAtk: 30, magDef: 20 },
        description: 'Original Darksaber relic robe. Preserves GETITEM 1000 and original price 0.',
        descriptionKr: '원작 다크세이버 유물 로브. GETITEM 1000과 원작 가격 0을 보존합니다. 신의 내린 가장 강력한 마공력을 지닌 로브.',
        rarity: 'unique',
        weight: 5.4,
        baseValue: 1,
        sellable: false,
    ...
    {
        id: 'orig_story_0975_chaos_linger', name: 'Chaos Linger', nameKr: '카오스링거',
        slot: 'weapon', gridW: 1, gridH: 3, color: '#b8a48c', icon: '🔱',
        iconSprite: { col: 50, row: 3 },
        maxDurability: 7000,
        stats: { atk: 230 },
        attackRange: 2,
        description: 'Original Darksaber relic weapon. Preserves GETITEM 975, magic 906, and original price 0.',
        descriptionKr: '원작 다크세이버 유물 무기. GETITEM 975, 발동마법 906, 원작 가격 0을 보존합니다. 혼돈의마력을 지닌 창.',
        rarity: 'unique',
        weight: 2.3,
        baseValue: 1,
        sellable: false,
