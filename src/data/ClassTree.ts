...
const INFANTRY: ClassLine = {
    ...
    growth: GROWTH_MELEE, baseMovRange: 6, attackRange: 1,
...
const CAVALRY: ClassLine = {
    ...
    growth: GROWTH_CAVALRY, baseMovRange: 9, attackRange: 2,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
...
const FLYING: ClassLine = {
    ...
    growth: GROWTH_FLYING, baseMovRange: 10, attackRange: 1,
...
const NAVAL: ClassLine = {
    ...
    growth: GROWTH_NAVAL, baseMovRange: 7, attackRange: 1,
...
const LANCER: ClassLine = {
    ...
    growth: GROWTH_LANCE, baseMovRange: 6, attackRange: 2,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
...
const ARCHER: ClassLine = {
    ...
    growth: GROWTH_ARCHER, baseMovRange: 7, attackRange: 4,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
...
const CLERIC: ClassLine = {
    ...
    growth: GROWTH_CLERIC, baseMovRange: 4, attackRange: 1,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
...
const PRIEST: ClassLine = {
    ...
    growth: GROWTH_PRIEST, baseMovRange: 5, attackRange: 1,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
...
const SHRINE: ClassLine = {
    ...
    growth: GROWTH_SHRINE, baseMovRange: 6, attackRange: 1,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
...
const MAGE: ClassLine = {
    ...
    growth: GROWTH_MAGE, baseMovRange: 5, attackRange: 3,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
...
const CULTIST: ClassLine = {
    ...
    growth: GROWTH_CULTIST, baseMovRange: 5, attackRange: 3,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
...
const ALCHEMIST: ClassLine = {
    ...
    growth: GROWTH_ALCHEMIST, baseMovRange: 6, attackRange: 2,
    ignoresTerrain: false, waterBonus: false,
    tiers: [
